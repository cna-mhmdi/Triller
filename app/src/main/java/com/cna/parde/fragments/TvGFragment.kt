    ...
    override fun onCreateView(
        ...
        binding.GChipGroup.setOnCheckedChangeListener { _, checkedId ->
            if (checkedId != View.NO_ID) {
                when (checkedId) {
                    R.id.cActionAdventure -> {
                        callingViewModel(10759)
                    }
                    ...
                    R.id.cNews -> {
                        callingViewModel(10763)
                    }

                    R.id.cReality -> {
                        callingViewModel(10764)
                    }

                    R.id.cSciFiFantasy -> {
                        callingViewModel(10765)
                    }

                    R.id.cSoap -> {
                        callingViewModel(10766)
                    }

                    R.id.cTalk -> {
                        callingViewModel(10767)
                    }

                    R.id.cWarPolitics -> {
                        callingViewModel(10768)
                    }
